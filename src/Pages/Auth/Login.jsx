...
//       "password": password
//     } 
//     let loginingUser = await axios.post("http://localhost:4000/api/auth/login", objToSend)

//     if (loginingUser?.data?.status === "00") {
//       console.log(loginingUser);

//       localStorage.setItem("user-auth-token", loginingUser?.data?.data)

//       const decoded = jwtDecode(loginingUser?.data?.data)

//       console.log('Decoded Payload:', decoded);

//       if (decoded?.userId?.ROLE === 2) {
//         navigate("/user")
//         toast.success("SignUp Successfully")
//       } else if (decoded?.userId?.ROLE === 1) {
//         navigate("/admin")
//         toast.success("SignUp Successfully")
//       } else if (decoded?.userId?.ROLE === 0) {
//         console.log("navigate karna chahyae na");
...
//     } else {
//       console.log(loginingUser)
//       toast.error(loginingUser?.data?.message)
//     }
//   }
//   return (
...
//           <h1 className="text-sm font-semibold mb-6 text-white text-center">Login To Access Your Dashboard</h1>
...
//                 <input type="text" id="username" placeholder="Enter User Name" name="username" className="mt-1 p-2 w-full border rounded-md focus:border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 transition-colors duration-300" />
//               </div> */}
//             <div>
//               <label htmlFor="email" className="block text-sm font-medium text-gray-100">Email</label>
//               <input type="text" id="email" name="email" placeholder="email@email.com" className="mt-1 p-2 w-full border rounded-md focus:border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 transition-colors duration-300" />
//             </div>
//             <div>
//               <label htmlFor="password" className="block text-sm font-medium text-gray-100">Password</label>
//               <input type="password" placeholder="******" id="password" name="password" className="mt-1 p-2 w-full border rounded-md focus:border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 transition-colors duration-300" />
//             </div>
//             <div>
//               <button type="submit" className="w-full flex justify-center items-center bg-[#E6E6E6] text-black p-2 rounded-md hover:bg-gray-800 hover:text-white  focus:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors duration-300 mt-4">Login</button>
//             </div>
//           </form>
//           <div className="mt-4 text-sm text-white text-center">
//             <p>Already have an account? <Link to={"/signup"} className="text-gray-400 hover:underline">SignUp here</Link>
//             </p>
//           </div>
//         </div>
//       </div>
